  ...
  return (
    <>
      <Box px={3}>
        ...
        {/* <Dialog open={open1}>
          <DialogTitle>Hãy nhập mã OTP được gửi trong tin nhắn</DialogTitle>
          <DialogContent>
            <form>
              <FormControl
                autoComplete="1x"
                ...
                fullWidth
              >
                <InputLabel htmlFor="standard-adornment-Email">OTP</InputLabel>
                <Input id="standard-adornment-OTP" type="number" />
              </FormControl>
            </form>
          ...
          <DialogActions>
            ...
            <Button id="OTP" onClick={CheckOTP}>
              Xác nhận
            </Button>
          </DialogActions>
        </Dialog> */}
